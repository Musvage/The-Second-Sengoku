...
NDiplomacy = {
	...
	TENSION_PEACE_FACTOR = 0.25,					-- scale of the amount of tension (from war declaration) reduced when peace is completed. Scaled by current world threat * TENSION_PEACE_FACTOR_THREAT_FACTOR
...
NAir = {
	...
	AIR_WING_BOMB_DAMAGE_FACTOR = 0.2,					-- (vanilla was 2, it was nuke carpet bombing) Used to balance the damage done while bombing.
